<template>
  <div class="px-[15px] py-[10px] bg-white">
    <div class="flex items-center space-x-[6px]">
      ...
      <span class="truncate text-lg text-primary-100 flex-grow text-left">{{ project.name }}</span>
    </div>
    ...
    <van-row :gutter="10" class="font-sm text-primary-200 mt-[6px]">
      ...
      <van-col :align="'left'" :span="18" class="text-primary-300">{{ dateRange }}</van-col>
      <van-col :align="'left'" :span="6" class="font-bold">预期成果</van-col>
      <van-col :align="'left'" :span="18" class="text-primary-300">{{ project.researchOutcome }}</van-col>
      <van-col :align="'left'" :span="6" class="font-bold">研究方向</van-col>
      <van-col :align="'left'" :span="18" class="text-primary-300">{{ project.researchArea }}</van-col>
    </van-row>
