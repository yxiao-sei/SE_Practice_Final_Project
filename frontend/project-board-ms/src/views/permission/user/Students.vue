<template>
  ...
  <update-item-modal role="student" :visible="updateModal.visible" :fillData="fillData" v-model="updateModal.visible"
    v-bind="updateModal" @close-modal="closeModal" />
</template>
...
import UpdateItemModal from "./UpdateStudent.vue";
